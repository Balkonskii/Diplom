	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.children_profile:
	        	...
	        	myIntent.putExtra("previousActivity", ActivityEnum.NotesForm.toString());
...
//		for (int i = 0; i < 50; i++) {
//			Note note1 = new Note();
//			note1.setTitle("title" + i);
//			note1.setDescription("asdasdasdasdasddfd'kgjd;jklfgnkjd;fngjkdfAAAAAAAAAAAAAAAAAAAAAABBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
//			note1.setPhoto(DataManager.getImageBytes(bmp));
//			if (i % 5 == 0) {
//				note1.hasImage = false;
//			}
//			listViewNoteAdapter.addItem(note1);
//		}
