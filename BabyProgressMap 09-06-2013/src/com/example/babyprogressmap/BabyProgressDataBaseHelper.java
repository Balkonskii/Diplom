...
public class BabyProgressDataBaseHelper extends SQLiteOpenHelper {
	...
	public static final String CREATE_TABLE_NOTICE = "create table "
			...
			+ " text," + NOTICE_NOTE_ID + " integer," + "foreign key("
			+ NOTICE_NOTE_ID + ") references " + NOTE_TABLE_NAME + "("
			+ NOTE_ID + "));";
	...
	public static final String CREATE_TABLE_NOTE = "create table "
			...
			+ NOTE_PHOTO + " blob," + NOTE_WITH_IMAGE + " integer," +NOTE_DURATION + " real,"
			+ NOTE_CHILDREN_ID + " integer," + "foreign key("
			+ NOTE_CHILDREN_ID + ") references " + CHILDREN_TABLE_NAME + "("
			+ CHILDREN_ID + "));";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		db.execSQL("DROP TABLE IF EXISTS " + NOTETYPE_TABLE_NAME);
		onCreate(db);
	}

	public void onCreate(SQLiteDatabase database) {
		database.execSQL(CREATE_TABLE_NOTETYPE);
