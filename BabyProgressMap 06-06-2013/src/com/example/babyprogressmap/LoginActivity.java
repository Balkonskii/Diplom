...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLoginFormView = findViewById(R.id.activity_login_scroll);
		...
		findViewById(R.id.sign_in_button).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						...
						DataManager.getChildren().setName("newName");
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			ArrayList<Account> accounts = adapter.getAccounts();
			boolean registered = false;
			
			for(Account a : accounts)
			{
				if(a.getLogin() == mEmailView.getText().toString() && a.getPassword() == mPasswordView.getText().toString())
				{
					registered  = true;
					break;
				}
			...
			else
			{
				...
				public void onClick(DialogInterface dialog, int which) {               														
					Intent myIntent = new Intent(getBaseContext(),
							RegistrationActivity.class);
					myIntent.putExtra("login",mEmailView.getText());
					//myIntent.putExtra("password",mPasswordView.getText());					
					startActivity(myIntent);
