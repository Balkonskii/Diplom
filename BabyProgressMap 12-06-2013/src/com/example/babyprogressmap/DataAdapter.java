...
public class DataAdapter {
	...
	public static final String DATE_TIME_FORMAT_REVERSED = "HH:mm:ss yyyy-MM-dd";
	...
	public long insertNotice(Notice notice) {
		ContentValues cv = new ContentValues();
		// cv.put(BabyProgressDataBaseHelper.NOTICE_NOTE_ID,
		// notice.getNoteId());
	...
	public ArrayList<Note> getNotes() {
		...
		while (cur.moveToNext()) {
			...
			note.setDuration(cur.getDouble(6));
			note.setChildrenId(cur.getInt(7));
			list.add(note);
		}
		return list;
	}
