...
public class ChangeChildrenProfile extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId() != R.id.logout) {
			...
			if (count == 0) {
				Toast.makeText(this, "Нет ни одного профиля", Toast.LENGTH_LONG);
				return true;
			} else if (selectedChildrenId == -1) {
				Toast.makeText(this, "Ничего не выбрано", Toast.LENGTH_LONG);
				return true;
			}
		}
		Intent myIntent;
		...
		case R.id.children_profile:
			...
			myIntent.putExtra("previousActivity", ActivityEnum.ChangeChildrenProfile.toString());
			startActivity(myIntent);
			return true;
		case R.id.notes:
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.edit:
			...
			myIntent.putExtra("previousActivity",
					ActivityEnum.ChangeChildrenProfile.toString());
			startActivity(myIntent);
			return true;
		case R.id.delete:
